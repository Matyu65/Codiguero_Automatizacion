package co.com.codiguero.guias.web.utilities.runner;

import co.com.codiguero.guias.web.utilities.exceldata.BeforeRunner;
 ...
 *  @sice 01/11/2019
 * */
public class RunnerCapaWeb extends Runner {
  private static final Logger LOGGER = LogManager.getLogger(RunnerCapaWeb.class.getName());
  private Class<CucumberWithSerenity> classValue;
  private CucumberWithSerenity cucumberWithSerenity;

  public RunnerCapaWeb(Class<CucumberWithSerenity> classValue)
