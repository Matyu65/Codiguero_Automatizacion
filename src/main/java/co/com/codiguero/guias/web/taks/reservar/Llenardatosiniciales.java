package co.com.codiguero.guias.web.taks.reservar;

import co.com.codiguero.guias.web.utilities.datos.DatosPrueba;
import net.serenitybdd.screenplay.Actor;
import net.serenitybdd.screenplay.Task;
import net.serenitybdd.screenplay.actions.Click;
import net.serenitybdd.screenplay.actions.type.Type;

import static co.com.codiguero.guias.web.userinterface.reserva.MainReserva.*;
